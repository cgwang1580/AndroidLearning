...
从事Android开发已经一年有余，但是对于Android底层知识从未触碰过，最近也有希望了解这方面知识的想法，想到先尝试编译Android源码并进行刷机。本篇文章用于记录源码编译及刷机过程，及碰到的一些问题。

## 准备

Android源码编译有比较多的坑，如果没有对应上环境、版本号的因素，往往会出现很多难以解决的问题，如下为本文测试环境、设备等：    
环境：Ubuntu 16.0.4 Git Repo   
版本：Android 7.0，   
设备：Nexux 6    
